...
?>
 ...
 <header  role="banner" class=" 1st-menu" style="background:#666;">
  ...
  <li><a href="#main-content" class="active"><i class="fa fa-arrow-down"></i>Skip to main content</a></li>
      ...
      <?php endif; ?>
          ...
          <div class="navbar-header col-md-2">      
              <form class="search-form example" action="/search/node" style="margin:auto;max-width:300px">
                  <input type="text1"  name="keys" placeholder="Search.." >
...
<div class="navbar-header col-md-12">
 ...
 <!-- /#page-header -->
<div class="container-fluid no-padding bg-img">
 <h1 class="page-header page-mar"><?php print $title; ?></h1>
</div>
