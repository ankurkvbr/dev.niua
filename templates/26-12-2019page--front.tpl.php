      ...
      <?php if ($logo): ?>
        <a class="logo navbar-btn pull-left" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
          <img src="/sites/all/themes/color_glass/images/NIUA_logo_white.png" class="img-responsive logo-nav2" style="display:none" alt="<?php print t('Home'); ?>" />
            <img src="/sites/all/themes/color_glass/images/NIUA_logo_white.png" class="img-responsive logo-nav1" alt="<?php print t('Home'); ?>" />
        </a>
      <?php endif; ?>
...
<div class="section-counter paralax-mf bg-image" style="background-image: url(/sites/all/themes/color_glass/images/2ugf.jpg)">
