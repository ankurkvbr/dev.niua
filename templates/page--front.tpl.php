  ...
  <div class="second-sub menu">
      ...
      <?php endif; ?>
          ...
          <div class="navbar-header col-md-2">      
              <form class="search-form example" action="/search/node" style="margin:auto;max-width:300px">
                  <input id='searchBar' type="text1"  name="keys" placeholder="Search.." >
                  <button type="submit"><i id='toggle-search' class="fa fa-search"></i></button>
                </form>
            </div>
            </div>
<!--/.navbar-collapse -->
...
<!--events-news text-->
<div class="hom-txt-back" id="overview">
<div class="page-mar">
...
<div class="new-event">
    <div class="page-mar">
  <div class = "container-fluid" id="new-event">
  <div class = "row n-e">
...
<div class="page-mar">
  <div class = "container-fluid hom-txt " id="glance">
  <div class = "row n-e-text">
       <div class = "col-sm-12 text-center">
...
<div class="counter-box counter-box pt-4 pt-md-0 aos-init aos-animate" data-aos="fade-right"data-aos-offset="100"data-aos-easing="ease-in-sine">
	...
	<div class="counter" data-count="<?= $projDetails['employee_count']; ?>"><?= $projDetails['employee_count']; ?></div>
    <span class="counter-text" style="font-size:15px">Employee</span></div>
    </div>
        </div>-->

 <div class="col-sm-6 col-lg-6 aos-init aos-animate" data-aos="fade-right"
     data-aos-offset="200"
     data-aos-easing="ease-in-sine">
     <div class="counter-box counter-box pt-4 pt-md-0">
    <div class="counter-ico">
    <i class="fa fa-cubes fa-5x" aria-hidden="true" style="color:#BB9445"></i></div>
        <div class="counter-num">
        
		<div class="counter" data-count="<?= $projDetails['project_count']; ?>"><?= $projDetails['project_count']; ?></div>
        <span class="counter-text">Projects</span></div>
        </div>
        </div>
  ...
  <!--<div class="col-sm-3 col-lg-3 aos-init aos-animate" data-aos="fade-right"
    ...
    <div class="counter-ico">
     <i class="fa fa-id-card-o fa-5x" aria-hidden="true" style="color:#83CA53"></i></div>
		...
		<div class="counter" data-count="<?= $projDetails['client_count']; ?>"><?= $projDetails['client_count']; ?></div>
 ...
 <div class="col-sm-6 col-lg-6 aos-init aos-animate" data-aos="fade-right"
    ...
    <div class="counter-ico">
      <i class="fa fa-handshake-o fa-5x" aria-hidden="true" style="color:#F46F5F"></i>
        ...
        <div class="counter-num">
			<div class="counter" data-count="<?= $projDetails['Partners_count']; ?>" ><?= $projDetails['Partners_count']; ?></div>
...
<?php endif; ?>
 <!--   <div class="float-menu">
    <div class=" float-menu2">
  <ul>
      <li><a href="#overview">Overview</a></li>
      <li><a href="#new-event">News and Events</a></li>
    <li><a href="#glance">Niua at Glance</a></li>
     <li><a href="#dashboard">Dashboard</a></li>
      <li><a href="#footer-section">Useful Links</a></li>
        </ul>
</div>
    </div>-->
    
<nav class="sidemenu-bar">
          <ul>
              <a href="#overview"><li>Overview <i class="fa fa-info"></i></li></a>
              <a href="#new-event"><li>News and Events <i class="fa fa-calendar"></i></li></a>
              <a href="#glance"><li>NIUA at Glance <i class="fa fa-cubes"></i></li></a>
              <a href="#dashboard"><li>Contact us <i class="fa fa-address-book" aria-hidden="true"></i></li></a>
          </ul>
</nav>
...
<script src="/sites/all/themes/color_glass/js/jquery.countup.js"></script>
